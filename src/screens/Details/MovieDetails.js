...
import { relacionados_Api, Criar_Favs, buscar_Infos, atualizar_Views, buscar_Favs } from '../../data/Apis';
...
const MovieScreen = ({ navigation, route }) => {
    ...
    const UrlImage = route.params.Url // img
    const Tipo = route.params.Tipo // filme/serie/anime
    const Title = route.params.Name // nome
    const Categoria = route.params.Categoria // categoria
    ...
    const view = async () => {
        const viewUpdate = await atualizar_Views(idTitulo, (parseInt(visualizacoes) + 1))

        navigation.navigate('Player', {Link : Link, Titulo : Title, Info : " ", Img : imgAssistindo})
    }
                    ...
                    <ScrollView contentContainerStyle = {{paddingBottom: 25}}>
                        <View style={{ width: width }}>
                            ...
                            <View style = {styles.viewTitle}>
                                ...
                                <View style = {{width : '97%', alignItems : 'center', justifyContent : 'center', marginTop : 10, flexDirection : 'row'}}>
                        ...
                        <View style = {{height : 85, width : width, alignItems : 'center', justifyContent : 'center'}}>

                            <Pressable style = {[styles.assistir, {width : columns_number()}]} onPress={() => view()}>
                                <Icon style={{marginRight : 10}} type = "material-community" name = "play" size={30} color={'#fff'} />
                                <Text style = {{letterSpacing : 1 ,color : '#fff', fontSize : 18, fontWeight : '500'}}>
                                    ASSISTIR
                                </Text>
                            </Pressable>
